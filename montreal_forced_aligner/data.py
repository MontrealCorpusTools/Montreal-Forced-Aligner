...
class DatabaseImportData:
    ...
    speaker_objects: typing.List[typing.Dict[str, typing.Any]] = dataclasses.field(
        default_factory=list
    )
    file_objects: typing.List[typing.Dict[str, typing.Any]] = dataclasses.field(
        default_factory=list
    )
    text_file_objects: typing.List[typing.Dict[str, typing.Any]] = dataclasses.field(
        default_factory=list
    )
    sound_file_objects: typing.List[typing.Dict[str, typing.Any]] = dataclasses.field(
        default_factory=list
    )
    speaker_ordering_objects: typing.List[typing.Dict[str, typing.Any]] = dataclasses.field(
        default_factory=list
    )
    utterance_objects: typing.List[typing.Dict[str, typing.Any]] = dataclasses.field(
        default_factory=list
    )
    phone_interval_objects: typing.List[typing.Dict[str, typing.Any]] = dataclasses.field(
        default_factory=list
    )
    word_interval_objects: typing.List[typing.Dict[str, typing.Any]] = dataclasses.field(
        default_factory=list
    )
...
class Language(enum.Enum):
    ...
    @property
    def default_tokenization(self) -> str:
        if self.value in ["ja", "ko", "zh", "th", "zh-CN"]:
            return self.value
        return "simple"
...
class PhoneSetType(enum.Enum):
    ...
    def extra_questions(self) -> typing.Dict[str, typing.Set[str]]:
        ...
        from montreal_forced_aligner.helper import voiced_variants, voiceless_variants
...
class NgramHistoryState:
    ...
    word_to_prob: dict = dataclasses.field(default_factory=dict)
...
class PronunciationProbabilityCounter:
    ...
    ngram_counts: collections.defaultdict = dataclasses.field(
        default_factory=collections.defaultdict
    )
    word_pronunciation_counts: collections.defaultdict = dataclasses.field(
        default_factory=collections.defaultdict
    )
    silence_following_counts: collections.Counter = dataclasses.field(
        default_factory=collections.Counter
    )
    non_silence_following_counts: collections.Counter = dataclasses.field(
        default_factory=collections.Counter
    )
    silence_before_counts: collections.Counter = dataclasses.field(
        default_factory=collections.Counter
    )
    non_silence_before_counts: collections.Counter = dataclasses.field(
        default_factory=collections.Counter
    )
