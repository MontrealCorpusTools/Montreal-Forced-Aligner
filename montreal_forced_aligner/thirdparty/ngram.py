...
def collect_ngram_binaries(directory):
...
def validate_ngram_binaries():
    ...
    if not_found:
        print('The following opengrm-ngram binaries were not found in {}: {}'.format(bin_out,
                                                                                     ', '.join(sorted(not_found))))
        return False
    print('All required opengrm-ngram binaries were found!')
    return True
