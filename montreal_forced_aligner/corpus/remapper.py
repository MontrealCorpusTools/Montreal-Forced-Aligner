...
__all__ = ["AlignmentRemapper", "AlignmentDictionaryRemapper"]
...
class AlignmentDictionaryRemapper(
    PhoneRemapperMixin, MultispeakerDictionaryMixin, TopLevelMfaWorker
):
    def __init__(
        self,
        corpus_directory: typing.Union[str, Path],
