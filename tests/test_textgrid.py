...
from montreal_forced_aligner.textgrid import parse_ctm, map_to_original_pronunciation
...
def test_mapping():
    ...
    new_phones = map_to_original_pronunciation(cur_phones, subprons, DEFAULT_STRIP_DIACRITICS, DEFAULT_DIGRAPHS)
